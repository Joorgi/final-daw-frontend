...
export default function BrandCard(props: BrandProps) {
	return (
		<Link
			to={`/marca/${props.id}`}
			className='cursor-pointer hover:scale-125 hover:duration-300 w-56  bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700'
		>
